...
// Systeme d'evenements de Backbone, customisé
// ---------------
...
const Events = {
  ...
  trigger: function (name) {
    ...
    if (!name.match(/^change/) && parent) {
      do {
        parentArgs = [{ name: parent, originEventName: name }].concat(Array.prototype.slice.call(args));
    ...
    function getParentNamespace (name) {
      return (name.indexOf(":") !== -1) ? name.Array.prototype.slice(0, name.lastIndexOf(":")) : "";
    }
  },
